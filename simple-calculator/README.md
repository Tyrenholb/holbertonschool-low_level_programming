...
A simple calculator program that displays a menu of basic mathematical operations.

Features

Displays a menu with options for basic mathematical functions.
After selecting an option, the program prompts the user to enter two values: A and B.
